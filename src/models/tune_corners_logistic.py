...
from src.models.train_corners import TARGET_COLUMN, build_time_split  # noqa: E402
...
def main() -> None:
    ...
    tuning_metrics.to_csv(TABLES_DIR / "corners_logistic_tuning_metrics.csv", index=False)
    ...
    threshold_metrics.to_csv(TABLES_DIR / "corners_logistic_threshold_validation.csv", index=False)
    ...
    final_metrics.to_csv(TABLES_DIR / "corners_logistic_selected_threshold_metrics.csv", index=False)
    ...
    existing_metrics_path = TABLES_DIR / "corners_model_metrics.csv"
    ...
    comparison.to_csv(TABLES_DIR / "corners_final_controlled_comparison.csv", index=False)
    joblib.dump(best_model, MODELS_DIR / "logistic_regression_controlled_best.joblib")

    print("Corners LogisticRegression controlled tuning completed.")
